...
<div class="auth-page">
  ...
  <div class="auth-visual-panel" style="background-image: url('<?= e(app_url('assets/img/auth/login.png')) ?>');">
    <div class="auth-visual-content">
      ...
      <p class="premium-lead mb-0 text-white opacity-90">"Since joining UpLiftHub, I've managed to secure three interviews in just two weeks. Truly a life-changing platform."</p>
  ...
  <div class="auth-form-panel">
    <div class="auth-card-premium">
      ...
      <div class="card-premium border-0 bg-light shadow-none mb-4" style="border-radius: 1rem;">
        <div class="small">
          <span class="fw-bold text-indigo">Demo:</span> <code>test@test.com</code> / <code>password1</code>
        </div>
      </div>
      ...
      <form method="post" action="" novalidate>
        ...
        <div class="mb-4">
          ...
          <div class="auth-input-group">
            ...
            <input type="email" class="form-control" id="email" name="email" required placeholder="name@example.com" value="<?= e(trim((string) ($_POST['email'] ?? ''))) ?>">
          </div>
        </div>
        ...
        <div class="mb-4">
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <a href="#" class="small text-indigo fw-bold" data-bs-toggle="modal" data-bs-target="#forgotModal">Forgot?</a>
          </div>
          <div class="auth-input-group">
      ...
      <div class="text-center">
        ...
        <div class="row g-2">
          <div class="col-6">
            <a href="<?= e(app_url('register-jobseeker.php')) ?>" class="btn btn-outline-uplift w-100 small py-2">Job Seeker</a>
          </div>
          <div class="col-6">
            <a href="<?= e(app_url('register-recruiter.php')) ?>" class="btn btn-outline-uplift w-100 small py-2">Recruiter</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-content modal-premium reveal reveal-up">
      <form method="post" action="<?= e(app_url('forgot-password.php')) ?>">
        <div class="modal-header">
          ...
          <p class="text-muted small px-lg-4">Enter your email address and we'll send you a secure link to reset your password.</p>
        </div>
        <div class="modal-body">
          ...
          <div class="mb-2">
            ...
            <div class="auth-input-group">
              <i class="ri-mail-line"></i>
              <input type="email" class="form-control" id="reset_email" name="email" required placeholder="name@example.com">
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="submit" class="btn btn-brand w-100 py-3">Send Reset Link</button>
          <button type="button" class="btn btn-link text-muted small text-decoration-none w-100" data-bs-dismiss="modal">Back to Login</button>
        </div>
      </form>
    </div>
  </div>
