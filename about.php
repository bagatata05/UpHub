    ...
    <div class="container">
      <div class="row g-5 align-items-center">
        <div class="col-lg-6 reveal reveal-left">
          <img src="<?= e(app_url('assets/img/about_team.png')) ?>" alt="Our Team" class="img-fluid rounded-4 shadow-lg">
        </div>
        <div class="col-lg-6 reveal reveal-right">
          ...
          <div class="card-premium mb-4" style="background: var(--uplift-soft-blue); border: none;">
             <h4 class="h5 fw-bold mb-2">Sustainable Development Goal focus</h4>
             <p class="small text-muted m-0">
               <strong>SDG 1 — No Poverty</strong>: We align our efforts with global goals by providing direct pathways to jobs, targeted financial grants, and critical community services.
             </p>
          </div>
