...
<aside class="sidebar uplift-sidebar" id="dashboardSidebar">
  <div class="sidebar-brand">
    ...
    <div class="ms-2 logo-container">
      ...
      <small class="brand-sub text-muted" style="font-size: 0.7rem; letter-spacing: 0.05em; text-transform: uppercase;">Administration</small>
    </div>
    <button class="btn btn-light btn-sm sidebar-close-btn border-0 rounded-circle" onclick="toggleMobileSidebar()" aria-label="Close sidebar">
