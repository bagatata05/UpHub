      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 hero-entrance">
          <div class="hero-visual-wrapper">
            ...
            <img src="<?= e(app_url('assets/img/hero_main.png')) ?>" alt="Community Support" class="hero-image-main">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row g-5 align-items-center mb-5">
        <div class="col-lg-6 reveal reveal-left">
          <img src="<?= e(app_url('assets/img/applicant_hero.png')) ?>" alt="Job Seekers" class="bento-image shadow">
        </div>
      ...
      <div class="row g-5 align-items-center flex-lg-row-reverse">
        <div class="col-lg-6 reveal reveal-right">
          <img src="<?= e(app_url('assets/img/partner_hero.png')) ?>" alt="Recruiters" class="bento-image shadow">
        </div>
        <div class="col-lg-6 reveal reveal-left">
